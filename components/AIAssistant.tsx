...
import { SendIcon, UploadIcon, AssistantIcon, CameraIcon } from './IconComponents';
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="w-full py-3 pl-24 pr-24 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1F7A6B]"
              disabled={isLoading}
            />
            <div className="absolute left-4 flex items-center space-x-2">
              <button onClick={() => fileInputRef.current?.click()} className="text-gray-500 hover:text-[#1F7A6B]" title={t('assistant_upload_tooltip')}>
                  <UploadIcon />
                  <input type="file" ref={fileInputRef} onChange={handleImageUpload} className="hidden" accept="image/*" />
              </button>
              <button onClick={() => setIsCameraOpen(true)} className="text-gray-500 hover:text-[#1F7A6B]" title={t('assistant_camera_tooltip')}>
                  <CameraIcon />
              </button>
            </div>
            <button
